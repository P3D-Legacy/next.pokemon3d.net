<div class="col-12 row p-3 ">
    <h2 class="col-12 text-dark text-center crystal-textbox">Latest news</h2>
    @forelse(\App\CustHelpers\XenforoHelper::getNewsItems()['threads'] as $item)
        @if($loop->iteration > 5)
            @break
        @endif
    ...
    @empty
        <p class="col-12 text-dark text-center crystal-textbox">Nothing here.</p>
    @endforelse
</div>
