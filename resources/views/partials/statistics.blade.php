<div class="col-12 row p-3 ">
    ...
    <a href="#FORUM_LINK" class="col-12 showoff_item crystal-textbox pb-2 pt-2">
        <div class="row">
    ...
    <a href="#DISCORD_INVITE_LINK" class="col-12 showoff_item crystal-textbox pb-2 pt-2">
        <div class="row">
    ...
    <a href="#DOWNLOAD_LINK" class="col-12 showoff_item crystal-textbox pb-2 pt-2">
        <div class="row">
